...
if (system.args.length === 1) {
    ...
    page.onConsoleMessage = function(msg, lineNum, sourceId) {
        // console.log('CONSOLE #' + lineNum + ': ' + msg + ' in "' + sourceId + '"');
    };
    ...
    page.open(url, function(status) {
        if (status === 'success') {
            console.log(page.evaluate(function() {// JSON.prune : a function to stringify any object without overflow
